function Results = customBayesopt(ObjectiveFcn, VariableDescriptions, customKernel, varargin)
...
%
%     OBJECTIVEFCN   - A handle to the objective function to minimize. It
...
Results = customBayesianOptimization(Options, customKernel);
end
