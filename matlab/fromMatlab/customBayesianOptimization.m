classdef customBayesianOptimization
    ...
    %% Hidden API
    methods(Hidden)
        function this = customBayesianOptimization(Options, customKernel)
...
%             this = callOutputFcn(this, 'initial');
            ...
            while ~optimizationFinished(this, iteration)
                ...
                this.customKernel.trajectory.data(end+1,:) = this.PrivUserDataTrace{end,1}.data(1,:);
                this.customKernel.trajectory.policy(end+1,:) = this.PrivUserDataTrace{end,1}.policy(1,:);
                
                %visCartPole(this.customKernel.trajectory.data{iteration,1}, this.customKernel.simOpts.bounds);
...
%             if any(this.XTrain(end, :) ~= this.XNext)
%                 keyboard;
%             end
        ...
        function ObjectiveFcnGP = fitObjectiveFcnGP(this, BullAdjustment, BullAdjustmentN)
            if all(isnan(this.FTrain))
                ...
                if this.PrivOptions.IsObjectiveDeterministic
                    ...
                    ConstantFSigma = true;
                    ObjectiveFcnGP = iFitrgpRobust(this.customKernel, this.XTrain, this.FTrain, SigmaLowerBound, ...
        ...
        function ObjectiveEvaluationTimeGP = fitObjectiveEvaluationTimeGP(this)
            ...
            if ~any(FitIndices)
                ...
                ObjectiveEvaluationTimeGP = iFitrgpRobust(this.customKernel, this.XTrain(FitIndices,:), ...
        ...
        function ConstraintGP = fitConstraintGP(this, ConstraintTrain, isDeterministic)
            if all(isnan(ConstraintTrain))
                ...
                if isDeterministic
                    ...
                    sigma0 = SigmaLowerBound;
                    ConstantSigma = true;
                    ConstraintGP = iFitrgpRobust(this.customKernel, this.XTrain, ConstraintTrain, SigmaLowerBound, ...
                        'BasisFunction', 'constant', ...
                        'ConstantKernelParameters', ConstantKernelParameters, ...
        ...
        function ErrorGP = fitErrorGP(this)
            ...
            elseif all(this.ErrorTrain < 0)
                ...
                ErrorGP = iFitrgpRobust(this.customKernel, this.XTrain, this.ErrorTrain, SigmaLowerBound, ...
                    'BasisFunction', 'constant', ...
                    'ConstantKernelParameters', ConstantKernelParameters, ...
                    'FitMethod', 'exact', ...
                    'KernelFunction', 'ardmatern52', ...
...
function GP = iFitrgpRobust(customKernel, X, Y, SigmaLowerBound, varargin)
...
kernelFcn = @(Xm, Xn, theta) customKernel.covarianceFcn(Xm, Xn, theta, customKernel);
