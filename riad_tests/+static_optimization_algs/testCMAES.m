...
% opt_alg = static_optimization_algs.CMAESCallbackWrapper(optimizerInput, func);
...
% optimizerInput.insigma = 1;
% optimizerInput.xstart = [0, 0]';
% opt_alg = static_optimization_algs.CMAESWrapper(@(x) -func.eval(x'), optimizerInput);
