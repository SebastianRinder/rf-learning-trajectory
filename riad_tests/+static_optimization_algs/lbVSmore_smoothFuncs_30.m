...
% local bayes vs more 
rootPlot = '+static_optimization_algs/xp_smoothGauss_10speri_20var_min30/';
...
for k = 1:nbAlgs
    ...
    settings{k}.nbSamplesPerIter = 30;
    settings{k}.nbInitSamples = 30;
    settings{k}.nbIter = 100;    
    settings{k}.maxIterReuse = 7;    
end
