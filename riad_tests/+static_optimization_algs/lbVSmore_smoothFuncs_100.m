...
% local bayes vs more 
rootPlot = '+static_optimization_algs/xp_smoothGauss_10speri_20var_min100/';
...
for k = 1:nbAlgs
    ...
    settings{k}.nbSamplesPerIter = 100;
    settings{k}.nbInitSamples = 100;
    settings{k}.nbIter = 100;    
    settings{k}.maxIterReuse = 3;    
end
